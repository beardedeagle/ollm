...
def _build_resolved_model(
    ...
    *,
    ...
    capabilities = CapabilityProfile(
        ...
        requires_processor=ModelModality.IMAGE in modalities
        or ModelModality.AUDIO in modalities,
...
def test_specialization_pipeline_selects_multimodal_shell_only_when_enabled(
    tmp_path: Path,
) -> None:
