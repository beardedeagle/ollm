...
def build_runtime_probe_command(
    ...
    *,
    ...
    probe_mode: ProbeMode = ProbeMode.COLD,
    prompt: str = "Say hi.",
    ...
    *,
    ...
    cold_generic = measure_runtime_probe(
        CommandBenchmarkSpec(
            ...
            timeout_seconds=cold_timeout_seconds,
        ),
        iterations=max(1, iterations),
        warmup_iterations=0,
        cwd=repo_root,
            ...
            "generic": measure_output_scaling_probe(
                CommandBenchmarkSpec(
                    ...
                    command=build_runtime_probe_command(
                        ...
                        offload_cpu_policy=offload_cpu_policy,
                        offload_gpu_layers=offload_gpu_layers,
                        probe_mode=ProbeMode.OUTPUT_SCALING,
            ...
            "generic": measure_session_growth_probe(
                CommandBenchmarkSpec(
                    ...
                    command=build_runtime_probe_command(
                        ...
                        offload_cpu_policy=offload_cpu_policy,
                        offload_gpu_layers=offload_gpu_layers,
                        probe_mode=ProbeMode.SESSION_GROWTH,
