...
messages = [
    ...
    },
    {
        ...
        "content": [
            {
                "type": "image",
                "image": "https://raw.githubusercontent.com/OpenBMB/MiniCPM-V/main/assets/minicpm-v-4dot5-framework.png",
            },
            {"type": "text", "text": "Describe this image in detail."},
        ],
    },
]
inputs = o.processor.apply_chat_template(
    messages,
    add_generation_prompt=True,
    tokenize=True,
    return_dict=True,
    return_tensors="pt",
).to(o.device, dtype=torch.bfloat16)
