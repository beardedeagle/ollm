...
# ====================================
path, out_dir = (
    "/home/mega4alik/Desktop/models/qwen3-next-80B/",
    "/media/mega4alik/ssd2/models/qwen3-next-80B/gds_export/",
)
wmap = json.loads(file_get_contents(f"{path}model.safetensors.index.json"))[
    "weight_map"
]
